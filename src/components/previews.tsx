...
export default function UserFeatures() {
  ...
  return (
    <div className="flex col flex-wrap justify-center lg:px-40 md:px-40 sm:px-40 space-y-10">
      <div className="flex col flex-wrap justify-center text-whitePurp font-semibold py-2 w-8/12">
      ...
      <div className="flex col flex-wrap justify-center text-whitePurp font-semibold py-2 w-8/12">
        ...
        <p className="flex flex-wrap justify-center text-center text-whitePurp border-t opacity-70 font-sans font-light left-0 py-3">
          Ever have those times where you don't know what to watch? Lists allow
          you to search through specfic genres to find what you're looking for.
          Maybe a classic or sad film, there is a list for what you want.
        </p>
      ...
      <div className="flex col flex-wrap justify-center text-whitePurp font-semibold py-2 w-8/12">
        ...
        <p className="flex flex-wrap justify-center text-center text-whitePurp border-t opacity-70 font-sans font-light left-0 py-3 ">
          Do you have any hills you want to die on? Maybe you 
          have some wild movie opinions that you'd love to discuss.
          Hot takes is an open field for discussion and debate about movie
          opinions that not everyone is going to love.
        </p>
